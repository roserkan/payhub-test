...
namespace Payhub.Infrastructure.Migrations
{
    ...
    [Migration("20250106080030_affiliate_commission")]
    partial class affiliate_commission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payhub.Domain.Entities.AffiliateManagement.Affiliate", b =>
                {
                    ...
                    b.Property<decimal>("DailyDepositLimit")
                        .HasColumnType("numeric")
                        .HasColumnName("daily_deposit_limit");

                    b.Property<decimal>("DailyWithdrawLimit")
                        .HasColumnType("numeric")
                        .HasColumnName("daily_withdraw_limit");

                    b.Property<bool>("DepositLimitExceeded")
                        .HasColumnType("boolean")
                        .HasColumnName("deposit_limit_exceeded");

                    b.Property<bool>("IsDepositActive")
                        .HasColumnType("boolean")
                        .HasColumnName("is_deposit_active");
                    ...
                    b.Property<bool>("IsWithdrawActive")
                        .HasColumnType("boolean")
                        .HasColumnName("is_withdraw_active");
                    ...
                    b.Property<decimal>("MaxWithdrawAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("max_withdraw_amount");
                    ...
                    b.Property<bool>("WithdrawLimitExceeded")
                        .HasColumnType("boolean")
                        .HasColumnName("withdraw_limit_exceeded");
            ...
            modelBuilder.Entity("Payhub.Domain.Entities.AffiliateManagement.AffiliateSite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Payhub.Domain.Entities.SafeManagement.AffiliateSafeMove", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("affiliate_safe_moves", (string)null);
                });
            ...
            modelBuilder.Entity("Payhub.Domain.Entities.TransactionManagement.Deposit", b =>
                {
                    ...
                    b.Property<decimal>("AffiliateCommission")
                        .HasColumnType("numeric")
                        .HasColumnName("affiliate_commission");
            ...
            modelBuilder.Entity("Payhub.Domain.Entities.TransactionManagement.Withdraw", b =>
                {
                    ...
                    b.HasOne("Payhub.Domain.Entities.AffiliateManagement.Affiliate", null)
                        .WithMany("Withdraws")
                        .HasForeignKey("AffiliateId");
            ...
            modelBuilder.Entity("Payhub.Domain.Entities.AffiliateManagement.Affiliate", b =>
                {
                    ...
                    b.Navigation("AffiliateSafeMoves");

                    b.Navigation("AffiliateSites");
